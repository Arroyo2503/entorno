 ...
 *
 * Recuerda que lo único que debes modificar es la línea 40, en la que se escribe tu nombre por pantalla.
 *
 * @author Profe
 */
...
public class Ejercicio01 {
    ...
    public static void main(String[] args) {
        ...
        //                Entrada de datos 
        //----------------------------------------------
        System.out.println("ESCALERA INCREMENTAL: PRUEBA DEL ALUMNO NOMBRE APELLIDO1 APELLIDO2");     // Cambiar por "PRUEBA DEL ALUMNO NOMBRE APELLIDO1 APELLIDO2"
        System.out.println("------------------------------------------------------------------");
        do {
